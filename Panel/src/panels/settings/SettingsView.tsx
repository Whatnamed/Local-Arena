...
export type SettingsEntry = "about" | "languages" | "personalization" | "directory" | "installation" | "experimental";
...
export default function SettingsView({ onClose, initialPage }: { onClose?: () => void; initialPage?: SettingsEntry }) {
  const [page, setPage] = useState<Page>("root");
  const { config, directory, installation } = useStore();
  const t = useT();
  // A dashboard tile can open this surface directly on one of its pages.
  useEffect(() => {
